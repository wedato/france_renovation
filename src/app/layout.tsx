          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center space-x-4">
                <a href="tel:0641392834" className="hover:text-construction-200 flex items-center">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="flex items-center">
                    ...
                    <a href="tel:0641392834" className="text-gray-400 hover:text-construction-400">06 41 39 28 34</a>
                  </p>
                  <p className="flex items-center">
                    <svg className="w-6 h-6 mr-2 text-construction-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
